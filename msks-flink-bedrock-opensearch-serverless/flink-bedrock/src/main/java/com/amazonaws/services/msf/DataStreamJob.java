...
public class DataStreamJob {
	...
	private static final String DEFAULT_SOURCE_TOPIC = "quickstart-events";
	...
	private static Properties getKafkaProperties(ParameterTool applicationProperties,String startsWith){
		...
		LOGGER.warn(startsWith+" Kafka Properties: "+properties);
		return properties;
	}

	private static KafkaSource<String> createKafkaSource(ParameterTool applicationProperties) {
		return KafkaSource.<String>builder()
				.setBootstrapServers(applicationProperties.get("source.bootstrap.servers","localhost:9092"))
...
// Define the RestClientFactory
		...
		env.execute("MSK - Flink Bedrock Application");
	}
